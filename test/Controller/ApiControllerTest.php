...
use OnePlace\Skeletonrequest\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/skeletonrequest/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/skeletonrequest/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('skeletonrequest-api');
    }
}
