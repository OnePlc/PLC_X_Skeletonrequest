<?php
/**
 * SkeletonrequestControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Skeletonrequest Module
 *
 * @category Test
...
namespace OnePlaceTest\Skeletonrequest\Controller;

use OnePlace\Skeletonrequest\Controller\SkeletonrequestController;
...
class SkeletonrequestControllerTest extends AbstractHttpControllerTestCase {
    public function setUp() : void {
        ...
        $this->setApplicationConfig([
            ...
            'modules' => ['OnePlace\Skeletonrequest'],
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/skeletonrequest', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('skeletonrequest');
        $this->assertControllerName(SkeletonrequestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('SkeletonrequestController');
        $this->assertMatchedRouteName('skeletonrequest');
    }
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/skeletonrequest/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('skeletonrequest');
        $this->assertControllerName(SkeletonrequestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('SkeletonrequestController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/skeletonrequest/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('skeletonrequest');
        $this->assertControllerName(SkeletonrequestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('SkeletonrequestController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/skeletonrequest/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('skeletonrequest');
        $this->assertControllerName(SkeletonrequestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('SkeletonrequestController');
