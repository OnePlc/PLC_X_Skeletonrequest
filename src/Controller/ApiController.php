<?php
/**
 * ApiController.php - Skeletonrequest Api Controller
 *
 * Main Controller for Skeletonrequest Api
 *
 * @category Controller
 * @package Application
...
class ApiController extends CoreController {
    ...
    /**
     * List all Entities of Skeletonrequests
     *
     * @return bool - no View File
     * @since 1.0.0
     */
    public function listAction() {
        ...
        # Get All Skeletonrequest Entities from Database
    ...
    /**
     * Get a single Entity of Skeletonrequest
     *
     * @return bool - no View File
     * @since 1.0.0
     */
    public function getAction() {
        ...
        try {
            ...
            $aReturn = ['state'=>'error','message'=>'Skeletonrequest not found','oItem'=>[]];
            echo json_encode($aReturn);
            return false;
        }

        # Print Entity
        $aReturn = ['state'=>'success','message'=>'Skeletonrequest found','oItem'=>$oItem];
        echo json_encode($aReturn);
